...
class TextAdapterGeneric(context: Context?,
                         private val resource: Int,
                         private val listPeople: ArrayList<DataFilters> ) : ArrayAdapter<DataFilters>(context, resource, listPeople), Filterable {
    private var dataList: ArrayList<DataFilters>? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        strName.text = getItem(position).filterName?.toUpperCase()
        return view
    }
    ...
    inner class ListFilter : Filter() {
        ...
        override fun performFiltering(prefix: CharSequence?): Filter.FilterResults {
            ...
            if (prefix == null || prefix.isEmpty()) {
                ...
                val searchStrLowerCase = prefix.toString().toUpperCase()
